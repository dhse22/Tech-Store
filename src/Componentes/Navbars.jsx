    ...
    return (
        <Navbar bg="dark" variant="dark">
            <Container>
                ...
                <Navbar.Brand><span>Tech Store</span>
                    <img className="Logo" src="https://w7.pngwing.com/pngs/633/104/png-transparent-technological-innovation-system-technology-computer-icons-research-electronics-innovation-system.png" alt="Logo" />
                </Navbar.Brand>
                <Nav className="me-auto">
                    <Nav.Link ><Link to='/'>Home</Link></Nav.Link>
                    <Nav.Link ><Link to='/Features' >Caracteristicas</Link></Nav.Link>
                    {
                        isAuthenticated ?
